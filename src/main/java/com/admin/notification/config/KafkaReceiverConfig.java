...
public class KafkaReceiverConfig extends KafkaBasicConfig {
    ...
    @Value("${app.kafka.group_id.NOTIFICATION_SERVICE_GROUP}")
    public String NOTIFICATION_SERVICE_GROUP;
    ...
    public ReceiverOptions<String, CloudEvent> getReceiverOptions() {
        ...
        basicConfig.put(ConsumerConfig.GROUP_ID_CONFIG, NOTIFICATION_SERVICE_GROUP);
        ...
        return basicReceiverOptions
                ...
                .subscription(Collections.singletonList(NOTIFICATION_RECEIVED_REQUEST));
    }

    @Bean
    public KafkaReceiver<String, CloudEvent> kafkaReceiver() {
        return KafkaReceiver.create(getReceiverOptions().subscription(List.of(
                NOTIFICATION_RECEIVED_REQUEST)));
    }
